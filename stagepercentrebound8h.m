...
%     end
        ...
        if ~isempty(mark1)
            ...
            a1=cell2mat(raw1((1:2:15),:));
            b1=cell2mat(raw1((2:2:16),:));
            c1=a1+b1;
            d1=c1/60;
        end
        ...
        if ~isempty(mark2)
            ...
            a2=cell2mat(raw2((1:2:15),:));
            b2=cell2mat(raw2((2:2:16),:));
            c2=a2+b2;
            d2=c2/60;
        end
        ...
        if ~isempty(mark3)
            ...
            a3=cell2mat(raw3((1:2:15),:));
            b3=cell2mat(raw3((2:2:16),:));
            c3=a3+b3;
            d3=c3/60;
        end
         ...
         if ~isempty(mark4)
            ...
            a4=cell2mat(raw4((1:2:15),:));
            b4=cell2mat(raw4((2:2:16),:));
            c4=a4+b4;
            d4=c4/60;
        end
    end
